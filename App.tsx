        ...
        <div className="min-h-screen bg-[var(--background)] text-foreground font-sans selection:bg-primary/30 selection:text-primary-foreground relative transition-colors duration-300">
          ...
          <header className="relative w-full h-screen overflow-hidden flex items-center justify-center">
            ...
            <motion.div 
              ...
              className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-muted-foreground z-20 pointer-events-none"
            >
              <span className="text-[10px] uppercase tracking-[0.2em] opacity-60">Kaydır</span>
              <ChevronDown className="animate-bounce text-muted-foreground opacity-60" size={20} />
            </motion.div>
          </header>
