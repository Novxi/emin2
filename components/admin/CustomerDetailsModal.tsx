        ...
        <div key="customer-details-modal" className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          >
            <div className="p-8 border-b border-border flex justify-between items-center bg-card/50">
              <div>
                <h3 className="text-2xl font-black text-foreground tracking-tight">Müşteri Detayları</h3>
                <div className="flex items-center gap-4 mt-1">
                  <p className="text-muted-foreground text-sm font-medium">{selectedCustomer.name} ({selectedCustomer.id})</p>
            ...
            <div className="flex border-b border-border bg-muted/20">
              {[
                { id: 'services', label: 'Hizmetler & Garanti', icon: Shield },
