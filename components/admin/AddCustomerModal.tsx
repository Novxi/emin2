            ...
            <div className="p-10 space-y-8">
              ...
              <form className="space-y-6" onSubmit={onSubmit}>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <Button variant="secondary" type="button" onClick={onClose} className="py-4 rounded-2xl text-xs font-black uppercase tracking-widest border-border">Vazgeç</Button>
                  <Button type="submit" className="py-4 rounded-2xl text-xs font-black uppercase tracking-widest">Müşteriyi Kaydet</Button>
                </div>
              </form>
            </div>
          </motion.div>
