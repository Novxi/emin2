            ...
            <div className="p-10 space-y-8">
              ...
              <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2">
                {services.map((service: any, idx: number) => (
                  <div key={`warranty-service-${service.id}-${idx}`} className="p-6 bg-card/50 rounded-2xl border border-border flex items-center justify-between group">
                    ...
                    <div className="flex items-center gap-2">
                      <input 
                        ...
                        className="bg-input/50 border border-border rounded-lg px-3 py-1.5 text-xs text-foreground focus:outline-none focus:border-primary" 
                      />
                      <Button variant="secondary" className="p-2 rounded-lg border-border">
