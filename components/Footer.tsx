        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-0">
              <div className="">
                <img src="/logo.png" alt="Logo" className="w-36 h-36 object-contain -mr-3" referrerPolicy="no-referrer" />
              </div>
              <span className="font-bold text-2xl tracking-tight text-foreground -ml-2">EMİN BİLGİ İŞLEM</span>
            </motion.div>
