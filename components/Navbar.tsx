      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
          <div className="relative flex items-center justify-between h-full">
            ...
            {/* Logo */}
            <Link to="/" className="flex items-center gap-6 group shrink-0 relative z-10 -space-x-8">
              <div className="relative">
                ...
                <div className="relative group-hover:scale-105 transition-transform duration-300">
                  <img src="/logo.png" alt="Logo" className="w-40 h-40 object-contain -mr-8" referrerPolicy="no-referrer" />
                </div>
              </div>
              <div className="flex flex-col leading-none -ml-6">
                <span className="font-black text-base tracking-tight text-foreground">EMİN</span>
                <span className="text-[9px] font-bold text-muted-foreground tracking-[0.2em] group-hover:text-primary transition-colors">BİLGİ İŞLEM</span>
              </div>
            </Link>
